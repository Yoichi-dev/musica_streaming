<template>
  <div>
    <div class="ycommentArea yscrollbar">
      <div id="ycomment"></div>
    </div>
    <div id="hidspace">
...
export default {
  ...
  methods: {
    ...
    createElement(comment, width, img) {
      ...
      element1.classList.add("yslidein");
      element1.classList.add("ykaiwa");
      element1.classList.add("yline");

      let element2 = document.createElement("div");
      element2.classList.add("yname");
      element2.textContent = comment.name;

      let element3 = document.createElement("div");
      element3.classList.add("yfukidasi");
      element3.classList.add("yleft");

      let giftImgElement = document.createElement("img");
      giftImgElement.classList.add("yicon");
      giftImgElement.classList.add("yjump");
      if (comment.kbn === "showroom") {
        giftImgElement.classList.add("iconclear");
      }
      giftImgElement.src = comment.avatar;

      if (width === "none") {
        if (comment.kbn === "youtube" && comment.customEmoji) {
      ...
      let myMain = document.getElementById("ycomment");
...
.ykaiwa.yline .yfukidasi.yleft {
  float: left;
  margin-left: 62px;
  /* background: white; */
}

.ykaiwa.yline .yname + .yfukidasi.yleft {
  font-size: 30px;
  margin-top: 15px;
}
...
.ykaiwa.yline .yname + .yleft .yicon {
  top: -1.8em;
}

.ykaiwa.yline .yfukidasi::after {
  position: absolute;
  content: "";
  width: 24px;
  height: 36px;
...
.ykaiwa.yline .yfukidasi.yleft:after {
  left: -10px;
